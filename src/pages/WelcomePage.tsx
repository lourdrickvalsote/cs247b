    ...
    return (
      <div className="min-h-screen bg-alice dark:bg-jet-950 flex flex-col items-center justify-center px-6">
        <div className="max-w-sm w-full text-center">
          <div className="mb-8">
            <div
              className="w-20 h-20 bg-forest rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg animate-bounce-in"
            >
              <Leaf className="w-10 h-10 text-white" />
            </div>
            <h1
              className="text-4xl font-bold text-jet mb-2 tracking-tight animate-fade-in"
  ...
  return (
    <div className="min-h-screen bg-alice dark:bg-jet-950 flex flex-col items-center justify-center px-6">
      <div className="max-w-sm w-full animate-fade-in">
        ...
        <div className="mb-8">
          <div className="w-12 h-12 bg-forest rounded-xl flex items-center justify-center mb-5 animate-scale-in">

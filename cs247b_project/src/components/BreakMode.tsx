...
export default function BreakMode() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-5rem)] px-6 animate-fade-in">
      ...
      <div className="text-center mb-8 animate-slide-down relative z-10">
        <p className="text-xs font-semibold text-forest uppercase tracking-widest mb-1">
          Break Time
        </p>
        <p className="text-sm text-lilac-600">Relax and recharge</p>
      </div>
        ...
        >
          <div className="text-center">
            <AnimatedDigits
              ...
              running={isRunning}
              className="text-5xl font-bold text-jet tracking-tight"
            />
            {isRunning && (
              <div className="flex items-center justify-center gap-1.5 mt-2 animate-fade-in">
                <span className="w-1.5 h-1.5 rounded-full bg-powder animate-pulse" />
                <span className="text-xs font-semibold text-powder-600 uppercase tracking-wider">
                  Resting
                </span>
              </div>
            )}
